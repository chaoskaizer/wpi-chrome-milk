...
function wpi_get_one_liner($display = false){
	...
	$q[] = "Just because your doctor has a name for your condition doesn't mean he knows what it is. ";
	...
	$q[] = "The light at the end of the tunnel is the headlight of an approaching train.";
	...
	$q[] = "Our website never has a bugs. It just develops random features.";	
	...
	$q[] = 'Wasting time is an important part of living.';
	$q[] = 'Only Robinson Crusoe had everything done by Friday.';
	$q[] = 'The early bird catches the worm';
	$q[] = 'The man who is swimming against the stream knows the strength of it';
	$q[] = 'Most problems are either unimportant or impossible to solve.';
	$q[] = 'Well done is better than well said. ~Benjamin Franklin';
	$q[] = 'Inform all the troops that communications have completely broken down.';
	$q[] = 'Advertising is 85% confusion and 15% commision.';
	$q[] = 'Logic is a system whereby one may go wrong with confidence.';
	$q[] = 'Start every day off with a smile and get it over with.';
	$q[] = 'I am free of all prejudices. I hate everyone equally.';
	$q[] = 'Life is too important to take seriously.';
	$q[] = 'Lord, what fools these mortals be! ~William Shakespeare';
	$q[] = 'If I didn\'t have a problem with alcohol, I\'d drink all the time.';
	$q[] = 'Everybody wants to go to heaven, but nobody wants to die. ';
	$q[] = 'Every man wishes to rule the world. Unfortunately, the world rules every man.';
	$q[] = 'We all have to die some day, if we live long enough.';
	$q[] = 'Please, Lord, let me prove that winning the lottery won\'t spoil me.';
	$q[] = 'Tell me what you need, and I\'ll tell you how to get along without it. ';
	$q[] = 'The difference between fiction and reality is that fiction has to make sense. ~Tom Clancy';
